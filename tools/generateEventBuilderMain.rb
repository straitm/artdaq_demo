...
def generateEventBuilderMain(ebIndex, totalFRs, totalEBs, totalAGs, compressionLevel, 
                         ...
                         fclWFViewer, ebHost, ebPort, withGanglia, withMsgFacility, withGraphite )
...
event_builder_code = generateEventBuilder( fragSizeWords, totalFRs, totalAGs, totalFragments, verbose, ebHost, ebPort, withGanglia, withMsgFacility, withGraphite)
