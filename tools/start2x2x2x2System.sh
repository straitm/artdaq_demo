...
echo "DataLoggerMain!`hostname`!id:${ARTDAQDEMO_AG_PORT[1]} commanderPluginType:xmlrpc" >> $tempFile
echo "RoutingMasterMain!`hostname`!id:${ARTDAQDEMO_AG_PORT[2]} commanderPluginType:xmlrpc" >> $tempFile
echo "RoutingMasterMain!`hostname`!id:${ARTDAQDEMO_AG_PORT[3]} commanderPluginType:xmlrpc" >> $tempFile
...
mkdir -p -m 0777 ${logroot}/routingmaster
